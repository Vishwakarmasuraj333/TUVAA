...
export default function CommunityStreetCleaningSection() {
  return (
    <section className="relative w-full h-[480px] md:h-[580px] overflow-hidden bg-zinc-950 flex items-center justify-center">
      {/* Background Image */}
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        />
        {/* Dark overlay */}
        <div className="absolute inset-0 bg-[#0d0905]/65 z-10" />
      </div>
      ...
      <div className="container max-w-4xl mx-auto px-6 relative z-20 text-center text-white space-y-4">
        <motion.div
          ...
          className="space-y-4"
        >
          <h2 className="font-cinzel text-lg sm:text-3xl md:text-4xl lg:text-5xl font-extrabold uppercase tracking-wider leading-tight whitespace-nowrap drop-shadow-md">
