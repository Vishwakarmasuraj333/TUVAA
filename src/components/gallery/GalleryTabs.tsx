...
export default function GalleryTabs({ initialItems }: GalleryTabsProps) {
  ...
  const handleImageClick = (index: number) => {
    // Correct index for lightbox relative to all tab items
  ...
  // Generate page numbers array strictly matching totalPages
  ...
  return (
    <div className="w-full" ref={galleryRef}>
      {/* Centered Tab Selectors with top margin 90px matching live site screenshot */}
      <div className="mt-[90px] flex flex-col items-center select-none">
      ...
      {activeTab !== null && tabItems.length > 0 && (
